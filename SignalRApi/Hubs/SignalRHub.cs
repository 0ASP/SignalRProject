...
namespace SignalRApi.Hubs
{
	public class SignalRHub : Hub
	{
		...
		public async Task SendStatistic()
		{
			...
			var value5 = _productService.TProductCountByCategoriNameHamburger();
			await Clients.All.SendAsync("ReceiveProductCountByCategoriNameHamburger", value5);

			var value6 = _productService.TProductCountByCategoriNameDrink();
			await Clients.All.SendAsync("ReceiveProductCountByCategoriNameDrink", value6);
